...
if (UNIX AND NOT APPLE)
  set(Caffe_known_gpu_archs "${PASCAL} ${VOLTA} ${TURING} ${AMPERE} ${ADA} ${HOPPER}")
...
function(op_select_nvcc_arch_flags out_variable)
  # List of arch names
  set(__archs_names "Pascal (CUDA >= 8)" "Volta (CUDA >= 9)" "Turing (CUDA >= 10)"  "All" "Manual")
  ...
  if (${CUDA_ARCH} STREQUAL "Pascal (CUDA >= 8)" AND NOT WIN32)
